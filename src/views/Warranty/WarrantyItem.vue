  ...
  <section class="content">
      ...
      <div class="box">
          <div class="box-body">
              <div class="row">
                  <div class="col-xs-4">
                      <input type="text" v-model="options.name" class="form-control input-sm" placeholder="保养项名称">
                  </div>
                  <div class="col-xs-2">
...
export default {
  ...
  methods: {
    ...
    async getList() {
      this.loading = true
      let res = await this.$api.item(this.options)
      this.loading = false
      if (0 === res.data.code) {
