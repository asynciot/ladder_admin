	        ...
	        <form class="form-horizontal" @submit.prevent="submit" data-vv-scope="form">
	            ...
	            <div class="box-body">
	                <div class="form-group">
	                    <label for="" class="col-sm-2 control-label">维保站点名称</label>
	                ...
	                <div class="form-group">
	                    ...
	                    <div class=" col-sm-8 col-md-6">
	                        <input type="text" v-model="form.contact" name="contact" v-validate="'required'" :class="{'form-control': true, 'is-error': errors.has('form.contact') }" placeholder="请输入">
	                    </div>
	                </div>
	                <div class="form-group">
	                    ...
	                    <div class=" col-sm-8 col-md-6">
	                        <input type="text" v-model="form.mobile" name="mobile" v-validate="'required'" :class="{'form-control': true, 'is-error': errors.has('form.mobile') }" placeholder="请输入">
	                    </div>
	                </div>
	            </div>
...
export default {
	...
	methods:{
		async getData(){
			let res = await this.$api.site({ id: this.$route.params.id})
